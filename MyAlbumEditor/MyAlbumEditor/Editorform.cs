    ...
    public partial class Editorform : Form
    {
        ...
        private void DisplayAlbum()
        {
            ...
            else
            {
                ...
                if (Manager.Album.PhotoDescriptor == PhotoAlbum.DescriptorOption.DataTaken)
        ...
        private void EnabledPhotoButton()
        {
        ...
        private void lstPhotos_MeasureItem(object sender, MeasureItemEventArgs e)
        {
            ...
            Rectangle sceledRect = ImageUtility.ScaleToFit(p.Image, DrawRect);

            Font f = lstPhotos.Font;
            string text = lstPhotos.GetItemText(p);
            int textWidth = (int)e.Graphics.MeasureString(text, f).Width;

            e.ItemWidth = sceledRect.Width + textWidth + 2;
            e.ItemHeight = Math.Max(sceledRect.Height, f.Height) + 2;
